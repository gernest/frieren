...
func TestCopyLongEnough(t *testing.T) {
	require.False(t, copyLongEnough(1, 3))
	require.True(t, copyLongEnough(1, 4))
	require.False(t, copyLongEnough(2047, 3))
	require.True(t, copyLongEnough(2048, 4))
	require.False(t, copyLongEnough(2048+1, 7))
	require.True(t, copyLongEnough(2048+1, 8))
	require.False(t, copyLongEnough(2048+1024+1, 15))
	require.True(t, copyLongEnough(2048+1024+1, 16))
	require.False(t, copyLongEnough(2048+1024+512+1, 31))
	require.True(t, copyLongEnough(2048+1024+512+1, 32))
	require.False(t, copyLongEnough(2048+1024+512+256+1, 63))
	require.True(t, copyLongEnough(2048+1024+512+256+1, 64))
	require.False(t, copyLongEnough(2048+1024+512+256+128+1, 127))
	require.True(t, copyLongEnough(2048+1024+512+256+128+1, 128))
	require.False(t, copyLongEnough(2048+1024+512+256+128+64+1, 255))
	require.True(t, copyLongEnough(2048+1024+512+256+128+64+1, 256))
	require.False(t, copyLongEnough(2048+1024+512+256+128+64+32+1, 511))
	require.True(t, copyLongEnough(2048+1024+512+256+128+64+32+1, 512))
	require.False(t, copyLongEnough(2048+1024+512+256+128+64+32+16+1, 1023))
	require.True(t, copyLongEnough(2048+1024+512+256+128+64+32+16+1, 1024))
	require.False(t, copyLongEnough(2048+1024+512+256+128+64+32+16+8+1, 2047))
	require.True(t, copyLongEnough(2048+1024+512+256+128+64+32+16+8+1, 2048))
	require.False(t, copyLongEnough(2048+1024+512+256+128+64+32+16+8+4+1, 4095))
	require.True(t, copyLongEnough(2048+1024+512+256+128+64+32+16+8+4+1, 4096))
}
...
func TestBinaryEncoder(t *testing.T) {
	...
	out = out[0:0]
	b.emitCopy(0, 5)
	require.Equal(t, []byte{0, 0, 5}, out)

	out = out[0:0]
	b.emitCopy(5, 5)
	require.Equal(t, []byte{0, 80, 5}, out)

	out = out[0:0]
	b.emitCopy(4095, 4095)
	require.Equal(t, []byte{255, 255, 255}, out)
}
func TestSnappyVsSloppy(t *testing.T) {
	...
	require.Equal(t, int(43104), sloppyBytes)
}
