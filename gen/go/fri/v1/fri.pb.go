...
var file_fri_v1_fri_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x42, 0x64, 0x0a, 0x06, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x31, 0x42, 0x08, 0x46, 0x72,
...
var file_fri_v1_fri_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_fri_v1_fri_proto_goTypes = []interface{}{
	(*FieldViewInfo)(nil), // 0: v1.FieldViewInfo
	(*Shard)(nil),         // 1: v1.Shard
	nil,                   // 2: v1.FieldViewInfo.ShardsEntry
	nil,                   // 3: v1.Shard.BitDepthEntry
}
var file_fri_v1_fri_proto_depIdxs = []int32{
	2, // 0: v1.FieldViewInfo.shards:type_name -> v1.FieldViewInfo.ShardsEntry
	3, // 1: v1.Shard.bit_depth:type_name -> v1.Shard.BitDepthEntry
