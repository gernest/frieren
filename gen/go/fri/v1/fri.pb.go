...
type Span struct {
	...
	EventAttributes   [][]byte `protobuf:"bytes,14,rep,name=event_attributes,json=eventAttributes,proto3" json:"event_attributes,omitempty"`
	...
	LinkAttributes    [][]byte `protobuf:"bytes,17,rep,name=link_attributes,json=linkAttributes,proto3" json:"link_attributes,omitempty"`
...
func (x *Span) GetEventAttributes() [][]byte {
	if x != nil {
...
func (x *Span) GetLinkAttributes() [][]byte {
	if x != nil {
		return x.LinkAttributes
	}
	return nil
}
...
var file_fri_v1_fri_proto_rawDesc = []byte{
	...
	0x28, 0x0c, 0x52, 0x0f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75,
	...
	0x6e, 0x6b, 0x54, 0x72, 0x61, 0x63, 0x65, 0x49, 0x64, 0x12, 0x27, 0x0a, 0x0f, 0x6c, 0x69, 0x6e,
	0x6b, 0x5f, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x18, 0x11, 0x20, 0x03,
	0x28, 0x0c, 0x52, 0x0e, 0x6c, 0x69, 0x6e, 0x6b, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74,
